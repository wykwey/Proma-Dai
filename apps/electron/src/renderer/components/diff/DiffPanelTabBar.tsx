    ...
    <div className="flex items-end h-[34px] tabbar-bg relative flex-shrink-0">
      ...
      <div className="relative flex items-end flex-1 titlebar-no-drag">
        <button
          ...
          className={cn(
            'flex-1 px-3 h-[34px] text-xs transition-colors select-none cursor-pointer whitespace-nowrap overflow-hidden rounded-none',
        ...
        <button
          ...
          className={cn(
            'flex-1 px-3 h-[34px] text-xs transition-colors select-none cursor-pointer relative whitespace-nowrap overflow-hidden rounded-none',
            'border-t border-l border-r',
            activeTab === 'changes'
              ? 'app-tab-active text-foreground border-border/80'
              : 'app-tab-inactive text-muted-foreground border-transparent hover:text-foreground',
        ...
        {showChatTab && (
          <div
            className={cn(
              'flex-1 h-[34px] text-xs transition-colors select-none relative whitespace-nowrap overflow-hidden rounded-none',
              'border-t border-l border-r',
              activeTab === 'chat'
                ? 'app-tab-active text-foreground border-border/80'
                : 'app-tab-inactive text-muted-foreground border-transparent hover:text-foreground',
